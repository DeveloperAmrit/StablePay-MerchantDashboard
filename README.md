...
* **pnpm** (Recommended) - *This project contains a `pnpm-lock.yaml` file.*

### Installation

1.  **Clone the repository**
    ```sh
    git clone [https://github.com/DjedAlliance/StablePay-MerchantDashboard.git](https://github.com/DjedAlliance/StablePay-MerchantDashboard.git)
    ```

2.  **Navigate to the dashboard directory**
    *The Next.js application is located in the `dashboard` folder.*
    ```sh
    cd StablePay-MerchantDashboard/dashboard
    ```
...
2.  **Clone your Fork**: `git clone https://github.com/YOUR_USERNAME/StablePay-MerchantDashboard.git`
